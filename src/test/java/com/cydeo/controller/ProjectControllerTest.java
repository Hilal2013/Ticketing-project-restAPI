...
//integration testing(testing all the layers)//im gonna need controller bean, service bean, need bunch of beans
@SpringBootTest
...
class ProjectControllerTest {
    ...
    static String token;
//why static =>i want to use all before methods.I want to use them in static methods
    ...
    void givenNoToken_getProjects() throws Exception {
        ...
        //i wasnt able to get the project insted /401 or 403  client error message
    }
    ...
    void givenToken_getProjects() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/v1/project")
                ...
                //what if i want get one field/ value inside json body
    ...
    private String toJsonString(final Object obj) throws JsonProcessingException {
        ...
        objectMapper.configure(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS, false);//just dates not timestamps
        objectMapper.registerModule(new JavaTimeModule());//2022/12/18
    ...
    private static String getToken() {
        ...
        map.add("client_secret", "Mnj6Sd0NAfGGo7tTQhWnZIEyR4RMTIKz");
